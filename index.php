...
/**
 * @package     Joomla.Site
 * @subpackage  Templates.lsm.2017_1
 *
 * @copyright   Copyright (C) 2017 Lar SAnta Mônica. All rights reserved.
		...
		<div id="all">
			<div id="back">
				<header id="header">
					...
					<ul class="skiplinks">
						<li><a href="#main" class="u2"><?php echo JText::_('TPL_LSM_2017_SKIP_TO_CONTENT'); ?></a></li>
						<li><a href="#nav" class="u2"><?php echo JText::_('TPL_LSM_2017_JUMP_TO_NAV'); ?></a></li>
						<?php if ($showRightColumn) : ?>
							<li><a href="#right" class="u2"><?php echo JText::_('TPL_LSM_2017_JUMP_TO_INFO'); ?></a></li>
						<?php endif; ?>
					</ul>
					<h2 class="unseen"><?php echo JText::_('TPL_LSM_2017_NAV_VIEW_SEARCH'); ?></h2>
					<h3 class="unseen"><?php echo JText::_('TPL_LSM_2017_NAVIGATION'); ?></h3>
					<jdoc:include type="modules" name="position-1" />
					<div id="line">
						<div id="fontsize"></div>
						<h3 class="unseen"><?php echo JText::_('TPL_LSM_2017_SEARCH'); ?></h3>
				...
				<div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
					...
					<?php if ($showRightColumn) : ?>
						<div id="close">
							...
							<span id="bild">
								<?php echo JText::_('TPL_LSM_2017_TEXTRIGHTCLOSE'); ?>
							</span>
							</a>
						</div>

						<aside id="right">
							<h2 class="unseen"><?php echo JText::_('TPL_LSM_2017_ADDITIONAL_INFORMATION'); ?></h2>
